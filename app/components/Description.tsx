...
export const Description = () => (
  <section className="flex h-[400px]  w-full flex-col items-center justify-center gap-4 bg-[url('/p2.png')] bg-cover bg-top p-4">
    <div className="text-xl font-bold text-blue-900 sm:text-4xl">
      帮助企业可持续增长的创新型咨询公司
    </div>
    <div className="mb-10 text-xl font-bold">聚焦业绩增长 常年顾问模式</div>
