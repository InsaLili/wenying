...
export const Description = () => (
  <section className="flex h-[300px] w-full  flex-col items-center justify-center gap-4 bg-[url('/img/p2.png')] bg-cover bg-top p-4 sm:h-[400px]">
    ...
    <div className="grid grid-cols-3 gap-4 p-2 sm:grid-cols-6">
      ...
      <Item img="./img/building.png" text1="20+" text2="常年顾问企业" />
    </div>
  </section>
);
